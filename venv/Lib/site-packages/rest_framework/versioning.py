...
class URLPathVersioning(BaseVersioning):
    ...
    urlpatterns = [
        re_path(r'^(?P<version>[v1|v2]+)/user/$', users_list, name='user-list'),
        re_path(r'^(?P<version>[v1|v2]+)/user/(?P<pk>[0-9]+)/$', users_detail, name='user-detail')
    ]
...
class NamespaceVersioning(BaseVersioning):
    ...
    # user/urls.py
    urlpatterns = [
        path('/user/', users_list, name='user-list'),
        path('/user/<int:pk>/', users_detail, name='user-detail')
    ]
